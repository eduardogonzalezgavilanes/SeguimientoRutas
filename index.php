...
<body>
    ...
    <b>Start1: </b>
    <input tye="text" id="start1" value="Flopec Esmeraldas, Simon Plata Torres, Esmeraldas, Ecuador"><!-- Starting Location -->
    <b>End1: </b>
    <input type="text" id="end1" value="Pontificia Universidad Católica del Ecuador - Sede Esmeraldas, Esmeraldas, Ecuador"><!-- Ending Location -->
    </div>
    <div id="map"></div>
    ...
    <script type="text/javascript">function calcDistance(p1, p2) {//p1 and p2 in the form of google.maps.LatLng object
